...
class Vehiculo:
    ...
    def __repr__(self) -> str:
        ...
        return f"Datos del Vehículo: {self.modelo}, Año: {self.año}, Chasis: {self.chasis}, Motor: {self.motor}\n"
...
class Motor:
    ...
    def __repr__(self) -> str:
        ...
        return f"Datos del Motor: {self.tipo}, Potencia: {self.potencia}, Peso: {self.peso}"
